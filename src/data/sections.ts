...
export const sections: Section[] = [
  {
    ...
    icon: 'sprout',
    lead: 'ボルシチでおなじみの赤紫色のビーツは、実はホウレンソウの仲間で、砂糖の原料になるテンサイとも親戚です。植物としての特徴や日本へ伝わった経緯、スーパーで選べる代表的な品種まで、ビーツの全体像をつかめる基礎知識をまとめます。',
    toc: [
      'ビーツとは？',
      'ビーツ・テンサイ・スイスチャードの違い',
      '世界での歴史と日本への伝来',
...
`,
  ...
  },
  {
    ...
    icon: 'activity',
    lead: 'ビーツは「奇跡の野菜」や「飲む輸血」と呼ばれることがあります。血管をゆるめる働きが報告されている硝酸塩、抗酸化作用を持つとされるベタレイン、葉酸、ナトリウムの排出を助けるカリウム。こうした栄養素について、臨床研究で確かめられている範囲を中心に、家庭目線で整理します。健康効果には個人差があり、ここでの内容は医療助言の代替ではありません。',
    toc: [
      'ビーツの栄養成分（100gあたり）',
      '主役は「硝酸塩」と一酸化窒素',
      'ベタレイン（赤色色素）の抗酸化作用',
...
`,
  ...
  },
  {
    ...
    icon: 'map',
    lead: 'スーパーのビーツは、これまで海外産の水煮缶やビン詰めが中心でした。近年は北海道や長野、熊本などで国産フレッシュビーツの栽培が広がり、産直市場やオンラインショップでも手に入りやすくなっています。ビーツが育つ環境、日本の主な産地、旬の時期を、産地ごとの特徴とともにまとめます。',
    toc: [
      'ビーツが育つ気候と栽培の特徴',
      '日本の主要産地',
      '旬の時期は年に2回',
...
60〜80日でも野菜としては短いほうですが、もっと手軽に、数日で収穫まで見届けたいなら、水だけで育てる[スプラウトの水耕](/sprout-info/grow/)という方法もあります。
...
`,
  ...
  },
  {
    ...
    icon: 'calendar',
    lead: 'ビーツは春まきと秋まきの2回つくれる野菜で、旬も年に2回あります。「いつが買いどき？」「家庭菜園でいつまけばいい？」という疑問に答えられるよう、種まき、収穫、出回りの時期を月別カレンダーにまとめました。地域や品種で前後するので、目安としてご覧ください。',
    toc: [
      'ビーツの旬はいつ？',
      '月別カレンダー',
      '種まきから収穫までの目安',
...
生のビーツが出回らない時期でも、**水煮（ボイル済みのパックや缶詰）** は一年を通して入手できます。生のビーツを下茹でして冷凍しておけば、季節を問わず使えて便利です。保存のコツは [保存方法](/beets-info/storage/) を参照してください。
...
`,
  ...
  },
  {
    ...
    lead: 'ビーツは初めてだと、買う段階からつまずきがちです。生のほかに水煮、冷凍、パウダーといった形があり、生と水煮では使い方も変わります。4つの形態の違いと使い分け、新鮮な生ビーツの見分け方、そしてどこで手に入りやすいかを、目的に合わせて選べるようにまとめます。',
    toc: [
      'ビーツの「形態」は4タイプ',
      '初めてなら何を選ぶ？目的別の選び方',
      '新鮮な「生ビーツ」の見分け方',
...
`,
  ...
  },
  {
    ...
    icon: 'chef-hat',
    lead: 'ビーツを初めて扱うと、下ごしらえの仕方と、手やまな板につく赤い色の2つでつまずきがちです。基本の下ごしらえを、皮ごと下ゆで、オーブンでロースト、生のままの3通りに分けて、それぞれのコツを説明します。赤い色移りを防ぐ方法と、ついてしまったときの落とし方もあわせてまとめます。',
    toc: [
      '下ごしらえは3通り：どれを選ぶ？',
      '基本①：皮ごと下ゆで',
      '基本②：オーブンでロースト',
...
`,
  ...
  {
    id: 'recipes',
    title: 'ビーツのレシピ｜ボルシチ・ピクルス・ポタージュなど目的別の食べ方',
    shortTitle: '料理とレシピ',
    description: 'ビーツの定番＆人気料理（ボルシチ・サラダ・スムージー・ピクルス・ポタージュ・ピンクのポテトサラダ）を目的別に紹介。鮮やかな色を活かした一品や、葉と茎の活用法まで家庭目線でまとめます。',
    icon: 'utensils',
    lead: '初めてのビーツでも作りやすい料理を、目的別に集めました。定番のボルシチやサラダ、作り置きのピクルス、おもてなしのポタージュ、お弁当が華やぐピンクのポテトサラダまで。鮮やかな色を活かせるのがビーツ料理の楽しさです。皮ごと加熱や色移り対策などの下ごしらえは [下ごしらえ](/beets-info/prep/) にまとめています。',
    toc: [
      '目的から選ぶ',
      'ボルシチ',
      'ビーツのサラダ',
    ...
    content: `ビーツの下ごしらえ（皮ごと加熱・きれいな色を保つコツ・加熱後の皮むき・手やまな板の色移り対策）は、[下ごしらえ](/beets-info/prep/) のページにくわしくまとめています。ここでは、下ごしらえを済ませたビーツで作れる **代表的な料理** と、捨てがちな **葉と茎** の使い方をご紹介します。
...
📖 ビーツを買った直後に、根と葉・茎を切り分けて別々に保存するのがコツです。一緒に置いておくと、葉に水分を奪われて根がしぼんでしまいます。詳しくは [保存方法](/beets-info/storage/) のページで解説します。

料理に慣れたら、ビーツの選び方や保存方法も知っておくと便利です。

[保存方法のページを読む](/beets-info/storage/)
`,
    updatedAt: '2026-05-18',
  },
  {
    id: 'storage',
    title: 'ビーツの保存方法｜冷蔵・冷凍で長持ちさせるコツと日持ちの目安',
    shortTitle: '保存方法',
    description: '生・加熱後のビーツを冷蔵・冷凍・ピクルスで長持ちさせる保存方法と、日持ちの目安、赤い茹で汁の活用法までを家庭目線で解説します。',
    icon: 'package',
    lead: 'ビーツは正しく保存すれば、おいしさを長く保てます。買ったらすぐにやること、生と加熱後それぞれの冷蔵保存、約3ヶ月もつ冷凍保存、ピクルスや乾燥での長期保存まで、日持ちの目安とあわせてまとめます。新鮮なものの選び方や形態の使い分けは [選び方・買い方](/beets-info/selection/) をご覧ください。',
    toc: [
      '葉付き・葉なしの違い',
      '買ったらすぐにやるべき2つのこと',
      '冷蔵保存の方法（生・茹で後）',
    ...
    content: `新鮮で良質なビーツの選び方（重さ・形・ツヤ・ひげ根などの見分け方）や、生・水煮・冷凍・パウダーといった形態の使い分けは、[選び方・買い方](/beets-info/selection/) のページにまとめています。ここでは、買ったあと **おいしさを保つ保存のしかた** に絞ってご紹介します。
...
ビーツを家に持ち帰ったら、調理する予定が数日先でも、できるだけ早く次の2つをやっておきましょう。
...
⚠️ 「きれいに洗ってから冷蔵庫に入れたい」気持ちは分かりますが、洗うのは調理する直前にしましょう。水分は傷みのもとになります。
...
たくさん買ってしまった時、すぐに食べきれない時には、冷凍保存が最も便利です。約3ヶ月の長期保存ができます。
...
⚠️ 生のまま冷凍することも可能ですが、解凍時に細胞が壊れて水分が抜けやすく、食感が落ちます。生のままよりは、加熱してから冷凍するのがおすすめです。
...
ビーツを食べるときに知っておきたい注意点と副作用は、次のページにまとめています。健康のために食べるなら、目を通しておくと安心です。
...
`,
  ...
  },
  {
    ...
    icon: 'alert-triangle',
    lead: 'ビーツを食べたあとに尿が赤くなる、お腹が張る、持病があって食べてよいか迷う。栄養が豊富な野菜ですが、人によっては注意したい点もあります。ビーツ尿やシュウ酸、腎臓やお腹への影響、ライフステージ別の摂取目安を、リスクを抑える具体策とあわせてまとめます。',
    toc: [
      'よくある現象「尿や便が赤くなる」',
      'シュウ酸と尿路結石リスク',
      'シュウ酸対策の3つの工夫',
...
ビーツを食べたあと、トイレで尿がピンク色や赤褐色になっていて驚く人がいます。これは医学用語で **「ビーツ尿（Beeturia／ビートゥリア）」** と呼ばれる、ごく一般的な現象です。
...
ビーツの健康効果は捨てがたいけれど、結石リスクも心配。そんなときに役立つ、シュウ酸の害を減らす3つの工夫があります。
...
ビーツは健康効果が期待される食材だからこそ、正しい知識を持って楽しむことが大切です。

...
`,
  ...
  },
  {
    ...
    icon: 'utensils',
    emoji: '🍽️',
    lead: '「ビーツを買ってきたけど、どうやって食べたらいい？」──そんな方へ、定番のボルシチやサラダから、作り置きのピクルス、おもてなしのポタージュ、お弁当が華やぐピンクのポテトサラダまで、目的別にご紹介します。鮮やかな色を活かせるのがビーツ料理の楽しさです。皮ごと加熱や色移り対策などの下ごしらえは [下ごしらえ](/beets-info/prep/) のページにまとめています。',
    toc: [
      '目的から選ぶ',
      'ボルシチ',
      'ビーツのサラダ',
...
`,
  ...
  },
  {
    ...
    icon: 'package',
    emoji: '🧊',
    lead: 'せっかく買ったビーツ、たくさんあるときや使いきれないときは、正しく保存すればおいしさを長く保てます。このページでは、買ったらすぐにやること、生・加熱後それぞれの冷蔵保存、約3ヶ月もつ冷凍保存、ピクルスや乾燥での長期保存までを順にご紹介します。新鮮なものの選び方や形態の使い分けは [選び方・買い方](/beets-info/selection/) をご覧ください。',
    toc: [
      '葉付き・葉なしの違い',
      '買ったらすぐにやるべき2つのこと',
      '冷蔵保存の方法（生・茹で後）',

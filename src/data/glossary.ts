...
export const glossary: GlossaryTerm[] = [
  ...
  },
  {
    ...
    reading: 'ビーツにょう',
    description:
      'ビーツ摂取後に尿がピンク〜赤褐色に変色する生理的現象（医学用語：Beeturia）。ベタシアニンが分解されずに尿中へ排出されるために起こる。多くの人にとっては無害（良性）とされ、通常1〜2日で元に戻る。',
    relatedSectionId: 'cautions',
  },
  {
    term: 'FODMAP',
  ...
  },
  {
    ...
    reading: 'こうカリウムけっしょう',
    description:
      '血中カリウム濃度が高くなりすぎた状態。腎機能低下時に発症リスクが高い。重症化すると不整脈など心臓への影響を招くことがあり、医療上の緊急事態とされる。ビーツ（根）は生100gあたり約325mg（USDA）と比較的カリウムが多いため、腎臓病の方は摂取に注意し主治医に相談する。',
    relatedSectionId: 'cautions',
  },
  {
    term: 'テーブルビート',
